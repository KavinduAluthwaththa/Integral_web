  ...
  return (
    <>
      ...
      <main className="bg-background">
        ...
        {/* Featured Products */}
        <section className="py-4xl border-y-2 border-foreground/40">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-xl">
                {featuredProducts.map((product, index) => (
                  <div key={product.id} className="space-y-lg">
                    <div className="relative aspect-[3/4] bg-secondary border-2 border-foreground/40 overflow-hidden group">
                      {product.image ? (
                        <Image
                          src={product.image}
                          alt={product.name}
        ...
        <section className="py-4xl">
          <div className="container mx-auto px-md">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3xl items-center">
              ...
              <div className="relative aspect-[4/5] bg-secondary border-2 border-foreground/40 overflow-hidden">
                <Image
